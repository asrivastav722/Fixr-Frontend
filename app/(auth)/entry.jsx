  ...
  return (
    <SafeAreaView className="flex-1 bg-white dark:bg-black">
      ...
      <View className="flex-row justify-end px-6 pt-4">
        <Pressable onPress={handleSkip} className="bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-full">
          <Text className="text-gray-600 dark:text-gray-300 font-bold text-xs uppercase tracking-widest">
            Skip
          </Text>
        </Pressable>
      </View>
      ...
      <View className="flex-1 px-8 justify-center pb-[100px]">
        <Text className="text-5xl font-black dark:text-white tracking-tighter">Fixr.</Text>
        <Text className="text-gray-500 text-lg mt-2">Professional services at your door.</Text>

        <View className="mt-12 flex-row items-center bg-gray-100 dark:bg-gray-900 rounded-2xl px-4 py-5 border border-gray-200 dark:border-gray-800">
          <Text className="text-lg font-bold dark:text-white mr-2">+91</Text>
